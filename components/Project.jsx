...
const Project = () => {
  return (
    <div>
            <h2 style={{textAlign: 'center'}} className='px-4 py-4 text-2xl tracking-wider items-center justify-center border-b'>All My project Done  </h2>
        ...
        <Link href='https://github.com/abdillah14'>
            <button  className='flex items-center justify-center  p-3 w-[30%] hover:scale-95 ease-in duration-300 mt-4'> <p>My project</p>   <AiOutlineEye className='pl-2' size={30}/></button>        
        </Link>   
        </div>
    </div>
  )
