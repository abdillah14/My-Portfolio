  ...
  return (
    <div>
      <h2
        ...
        className="px-4 py-4 text-2xl tracking-wider items-center justify-center border-b"
      >
        All My projects Done{" "}
      </h2>
      <p
        style={{ textAlign: "center" }}
        className="px-4 text-xl   sm:pr-20 py-2 flex items-center justify-center"
      >
      ...
      <div className="flex  items-center justify-center py-4">
        <Link href="https://github.com/abdillah14">
          <button className="flex items-center justify-center p-3  w-[100%] hover:scale-95 ease-in duration-300 mt-4">
            {" "}
            <p className="">See my project</p> <AiOutlineEye className="pl-2" size={30} />
          </button>
        </Link>
      </div>
    </div>
